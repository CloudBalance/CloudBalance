...
// React classes
  // Example
  // SourceObjects  - Google Dropbox containers
  // SourceObject  - File
  // Draggable  - File
  // DropTargets - Google Dropbox
  // DropTarget - Folders (Files with fileType: 'folder'), Google, Dropbox
...
(function() {
  ...
  var _ref = React.DOM, div = _ref.div, p = _ref.p;
  var LEFT_BUTTON = 0;
